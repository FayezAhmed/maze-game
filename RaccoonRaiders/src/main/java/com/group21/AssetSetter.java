...
public class AssetSetter {
    ...
    public void setObject(){
        ...
        gp.rewards[5] = new BubbleTea();
        gp.rewards[5].x = 6 * gp.tileSize;
        gp.rewards[5].y = 16 * gp.tileSize;

        gp.rewards[6] = new BubbleTea();
        gp.rewards[6].x = 36 * gp.tileSize;
        gp.rewards[6].y = 12 * gp.tileSize;

        gp.rewards[7] = new Coffee();
        gp.rewards[7].x = 30 * gp.tileSize;
        gp.rewards[7].y = 12 * gp.tileSize;
        ...
        gp.rewards[9].x = 36 * gp.tileSize;
        gp.rewards[9].y = 12 * gp.tileSize;

        // gp.punishments[3] = new Punishment();
        // gp.punishments[3].x = 21 * gp.tileSize;
        // gp.punishments[3].y = 9 * gp.tileSize;

        // gp.punishments[4] = new Punishment();
        // gp.punishments[4].x = 22 * gp.tileSize;
        // gp.punishments[4].y = 3 * gp.tileSize;

        // gp.punishments[5] = new Punishment();
        // gp.punishments[5].x = 24 * gp.tileSize;
        // gp.punishments[5].y = 5 * gp.tileSize;

        // gp.punishments[6] = new Punishment();
        // gp.punishments[6].x = 25 * gp.tileSize;
        // gp.punishments[6].y = 8 * gp.tileSize;
    }
